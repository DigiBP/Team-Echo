...
Our website was built using [Google Sites](https://sites.google.com/). The chatbot was integrated into the website with a few lines of code which can be viewed in the repositories.
    
2. Two integromat scenarios are triggered **on parallel**:
<ul>
...
Google sheet "Callers" is used to store the patient records <image src="https://user-images.githubusercontent.com/89810259/147171719-01cc3a6f-1dc1-4345-ad04-ceaf6d364a0d.png"><br><br>
BPMN overview<br>
...
Appsheet transforms our Google sheet "Callers" to a user-friendly data-monitoring platform with a modern user interface. <br><br>
          The app has been deployed to Google Play store and can be <a href="https://www.appsheet.com/newshortcut/d8319de6-210c-403e-84ba-f66f587d6f6b">installed on the mobile phone</a> for the paramedic to monitor the real-time status of the callers record. <br><br>
...
User interface on our Emergency Call app (iPad view):<br><image src="https://user-images.githubusercontent.com/89810259/147155999-e532d869-e31a-40aa-8b3a-b388433b54e1.png", width="500" height="700"><br><br>
        </li>
        </ul>
3. At this point, the paramedics are aware that a new patient needs to be assisted. The emergency call with the patient are forwarded to an Emergency Call Agent to give first aid instructions. Meanwhile, a paramedic prepares for the dispatch to pick up the patient.<br><image src="https://user-images.githubusercontent.com/89810259/147160442-f98c76ea-73d9-44f4-a911-e33523c95cfc.png" width="920" height="350"><br>
